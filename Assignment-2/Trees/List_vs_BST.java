...
public class List_vs_BST {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		String data_path = "/Users/nilaysadavarte/eclipse-workspace/UberCareerPrep/src/homework2/Trees/data.csv";
		String search_path = "/Users/nilaysadavarte/eclipse-workspace/UberCareerPrep/src/homework2/Trees/search.txt";

		// Scan the data file
		Scanner scan = new Scanner(new File(data_path));

		/*
		 * 	Parse each line from the file and populate both the phone books. Log total time taken for this.
		 */
		...
		System.out.println(book1.size() == 1000000 && book2.size() == 1000000);
		...
		/*
		 *  Create two lists to store answers for queries from each book, log the search times for each and check if the queries result in same answers.
		 */
		...
		System.out.println(ans1.containsAll(ans2));
